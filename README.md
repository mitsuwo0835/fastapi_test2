...
- [【Python】Amazon SP-APIで商品情報検索・データ取得｜物販セリングパートナーAPIの使い方徹底解説](https://di-acc2.com/system/rpa/14694/)  
- [Pythonで環境変数を活用する](https://www.twilio.com/blog/environment-variables-python-jp)  
- [FbaInboundEligibility — PYTHON-AMAZON-SP-API documentation](https://sp-api-docs.saleweaver.com/endpoints/fba_inbound_eligibility/)  
